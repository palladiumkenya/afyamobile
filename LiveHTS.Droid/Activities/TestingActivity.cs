...
{
    [Activity(Label = "HIV Tests", NoHistory = true, ParentActivity = typeof(DashboardViewModel), ConfigurationChanges = ConfigChanges.Orientation | ConfigChanges.ScreenSize | ConfigChanges.KeyboardHidden)]
